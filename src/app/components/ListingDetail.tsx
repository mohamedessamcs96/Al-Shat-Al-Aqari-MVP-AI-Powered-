...
import { ArrowRight, MapPin, Bed, Bath, Maximize, Star, Phone, Mail, Calendar, MessageCircle, DollarSign } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b sticky top-0 z-10 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <h1 className="text-lg font-semibold text-gray-900">تفاصيل العقار</h1>
          <div className="w-20" />
        </div>
      </header>
